-- FE Neko Maid Animations By Creo; For updates on (ORIGINAL NOT MY VERSION) script join this server
...
while true do
	...
	if CloneChar:FindFirstChild("Animation") and CloneChar.Animation.Value ~= "neko" then
		local Camera = workspace.CurrentCamera
		...
		Camera.CameraType = "Custom"
		Camera.CameraSubject = CloneChar
